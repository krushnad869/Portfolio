  ...
  const experiences = [
    {
      ...
      achievements: [
        'Improved keyword rankings & organic traffic across multiple client websites'
'Conducted comprehensive technical SEO audits and resolved critical issues'
'Executed high-quality backlink strategies to boost domain authority'
'Implemented effective on-page & off-page SEO campaigns with measurable results'
],
